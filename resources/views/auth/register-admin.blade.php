...
<div class="bg-white shadow-lg rounded-xl w-full max-w-sm p-8">
    ...
    <form method="POST" action="{{ route('register.admin.submit') }}" class="space-y-5">
        @csrf
        ...
        <div class="floating-input">
            <input type="text" name="security_code" placeholder=" " required>
            <label>Admin Security Code</label>
        </div>

        <button type="submit" class="w-full py-3 bg-red-500 hover:bg-red-600 text-white font-semibold rounded-lg shadow-sm mt-4">
            Register
        </button>
    </form>
